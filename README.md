...
This documentation is automatically generated by *epik8s-tools* (0.6.5).
...
| [vgcon01         ](#vgcon01) | xgs600     | vgc        | LEL:VAC:VGCON01:ICPDAS02 | agilent-vac | https://baltig.infn.it:infn-epics/agilentXgs600.git | opi/xgs600.bob | P=LEL:VAC:VGCON01              | https://servicedesk.infn.it/secure/ObjectSchema.jspa?id=44&typeId=2505&objectId=111736 |
...
|------------------|--------------------------------|---------------|--------------------------------|----------------------------------------------------|
  ...
  | notebook         | http://eli-notebook.apps.k8s-da.lnf.infn.it | -          | https://baltig.infn.it/epics-containers/jupyter-chart.git |                                                    |
