...
This documentation is automatically generated by *epik8s-tools* (0.6.0).
...
| [unimag          ](#unimag) | unimag     | mag        | LEL:MAG:                | unimag     | https://baltig.infn.it/infn-epics/unimag.git | opi/unimag.bob | CONFFILE= P=LEL:MAG TITLE=Unimag   | https://confluence.infn.it/display/SCS/Magnet+SoftIOC+Devil+Wrapper |
