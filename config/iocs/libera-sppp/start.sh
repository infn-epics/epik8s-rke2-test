...
if [ -n "$__IOC_PREFIX__" ];then
    ...
    sed  -i s/__IOC_PREFIX__/$__IOC_PREFIX__/g db/*.substitutions *.cmd
else
...
if [ -n "$__IOC_TOP__" ];then
    ...
    sed  -i s|__IOC_TOP__|$__IOC_TOP__|g db/*.substitutions *.cmd
else
...
if [ -n "$__IOC_NAME__" ];then
    ...
    sed  -i s/__IOC_NAME__/$__IOC_NAME__/g db/*.substitutions *.cmd
else
